...
namespace Core
{
    public class UIWindow : Core.StateMachine.StateMachine
    {
        ...
        [SerializeField]
        private bool closeByBackButton = true;
        [SerializeField]
        ...
        protected virtual void ActiveStateInitHandler()
        {
            ...
            EventManager.Subscribe(Events.InputEvents.BACK_BUTTON_PRESSED, Handler_BackButton);
        }
        ...
        protected virtual void ActiveStateCloseHandler()
        {
            ...
            EventManager.Unsubscribe(Events.InputEvents.BACK_BUTTON_PRESSED, Handler_BackButton);
        }
        ...
        protected virtual void Handler_BackButton(object sender, GameEventArgs e)
        {
            if (closeByBackButton && UIControl.Instance.IsTopWindow(ID))
                CloseThisWindow();
        }
